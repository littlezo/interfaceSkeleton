 ...
 * @FilePath    : \\route\\app.php
 */

use think\facade\Route;


Route::rule('/api/notify', '\app\service\v1\OrderService::notify');
Route::rule('/api/upload', '\app\service\v1\UploadService::upload');
Route::rule('/api', '\app\ServiceDispatch::run');
// ->https()
